...
<section id="tickets">
	...
	<p>
		What the Bot say: Sure! Here's a revised version of the text with a focus on a dub event: "Hey
	...
	{#if tickets}
		{#if tickets.free > 0}
			...
			<a href="https://www.eventbrite.com/e/dubstetten-tickets-509314502387" class="btn"
				>Order Tickets</a
			>
		{:else}
