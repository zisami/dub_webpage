...
<section id="about">
    <h3 class="title">About Dubstetten</h3>
    <p>Dubstetten is a family festival organised from the BELE association in cooperation with the Danubian Dub Soundsystem crew.</p>
    <Picture src="assets/img/dub_1.jpg" alt="dub together" />
    <hr />
